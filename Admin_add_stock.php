  ...
  <div class="bodywrap">
    ...
    <div class="content1">
      ...
      <form action="stock_in _factory_insert.php" method="POST">
        <h2>
          <center> New Sweet Entry</center>
        </h2>
        <?php echo $success;  ?>
        <table>
          <tr>
            <td width="133"><label>Sweet Name</label></td>
            <td width="163"><input type="text" name="sweetname" pattern="^[a-zA-Z]*$" required></td>
          </tr>
          <tr>
            <td><label>Base Materia</label></td>
            <td><input type="text" name="Basematerial" required></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td><input type="Date" name="mandate" required></td>
          </tr>
          <tr>
          ...
          <tr>
            <td height="26">
              <p id="check"><?php echo  $error1;  ?></p>
            </td>
            <td><button class="button1" onclick="">Add</button></td>
          </tr>
        </table>
      </form>
    </div>
    <div class="content2">
      ...
      <h2>
        <center>Existing Sweet stock Entry</center>
      </h2>
      <?php echo $success1;  ?>
      <form action="stock_in_factory_update.php" method="POST">
        ...
        <table width="373" height="261">
          <tr>
            <td><label>Sweet Name</label></td>
            <td><input type="list" list="sweet" name="sweet_list" required></td>
          </tr>
          <tr>
            <td><label>Quantity</label></td>
            <td><input type="text" name="Quantity" pattern="\d*" required></td>
          </tr>
          <tr>
            <td><label>Manufacture date</label></td>
            <td><input type="Date" name="mandate" required></td>
          ...
          <tr>
            <td><label id="check_id"><?php echo $error2; ?></label></td>
            <td><button class="button1">Add</button></td>
          </tr>
        </table>
      </form>
    </div>
    <div class="content3">
      <h2>
        <center>Delete From Stock</center>
      </h2>
      <form action="delete stock.php" method="POST">
        ...
        <table>
          <tr>
            <td><label>Sweet Name</label></td>
            <td><input type="list" list="sweet" name="sweet_list_del" required>
          </tr>
          <tr>
            <td><label id="check"></label></td>
            <td><button class="button1">Remove</button></td>
          </tr>
        </table>
        <?php echo $msg1; ?>
      </form>
